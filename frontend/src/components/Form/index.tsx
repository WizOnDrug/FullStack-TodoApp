...
//   return (
//     <div className="px-8 py-4 pb-8 rounded-lg bg-gray-500 bg-opacity-20 shadow-xl w-[300px] flex justify-center ">
...
//             </p>
//           )}
//           <label className="mb-2 text-slate-300">Title</label>
//           <input
//             id="title"
//             type="text"
//             placeholder="WiZ On DruG"
...
//           )}
//         </div>
//         <button className="rounded-lg bg-gray-500 bg-opacity-20 shadow-xl w-1/2 h-11 mt-2 hover:bg-gray-500 hover:bg-opacity-30 duration-300 text-indigo-400">
    ...
    <div className="px-8 py-4 pb-8 rounded-lg bg-gray-500 bg-opacity-20 shadow-xl w-[400px] flex justify-center ">
      <form onSubmit={(e) => (user.data.id ? fetchUpdate(e) : fetchCreate(e))}>
        <div className="mt-4">
          ...
          {errorForm.name && (
            <p className="mt-1 text-m text-red-400">This field is required</p>
          )}
          <label className="mb-2 text-slate-300">Title :</label>
          <input
            id="title"
